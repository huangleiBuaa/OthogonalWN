...
cmd:option('-save',"log_exp_debug_NoW" ,'subdirectory to save logs')
...
log_name='debug_NoW_'..baseString
...
torch.save('SModel_debug_NoW_'..baseString..'.t7', net:clearState())
end
